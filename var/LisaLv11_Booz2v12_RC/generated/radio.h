/* This file has been generated from /home/mav/paparazzi/conf/radios/cockpitSX.xml */
/* Please DO NOT EDIT */
...
#define NormalizePpmFIR(_ppm, _rc) {\
  ...
  _rc.values[RADIO_ROLL] = tmp_radio * (tmp_radio >=0 ? (MAX_PPRZ/(float)(RC_PPM_SIGNED_TICKS_OF_USEC(2050-1500))) : (MIN_PPRZ/(float)(RC_PPM_SIGNED_TICKS_OF_USEC(950-1500))));\
...
\
  ...
  _rc.values[RADIO_YAW] = tmp_radio * (tmp_radio >=0 ? (MAX_PPRZ/(float)(RC_PPM_SIGNED_TICKS_OF_USEC(950-1500))) : (MIN_PPRZ/(float)(RC_PPM_SIGNED_TICKS_OF_USEC(2050-1500))));\
