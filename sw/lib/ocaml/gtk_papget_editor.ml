(* Automatically generated from /tmp/gtk_papget_editor.ml_widgets.glade by lablgladecc *)

class papget_editor ?(file="/tmp/gtk_papget_editor.ml_widgets.glade") ?domain ?autoconnect(*=true*) () =
