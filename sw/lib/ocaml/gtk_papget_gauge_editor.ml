(* Automatically generated from /tmp/gtk_papget_gauge_editor.ml_widgets.glade by lablgladecc *)

class table_gauge_editor ?(file="/tmp/gtk_papget_gauge_editor.ml_widgets.glade") ?domain ?autoconnect(*=true*) () =
