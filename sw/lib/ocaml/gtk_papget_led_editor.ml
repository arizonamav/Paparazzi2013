(* Automatically generated from /tmp/gtk_papget_led_editor.ml_widgets.glade by lablgladecc *)

class table_led_editor ?(file="/tmp/gtk_papget_led_editor.ml_widgets.glade") ?domain ?autoconnect(*=true*) () =
